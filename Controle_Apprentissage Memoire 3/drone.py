...
class DroneGameAI:
    ...
    def get_state(self):
        ...
        dir_prev_prev = [0, 0, 0, 0]
        dir_prev_prev[self.dir_idx_prev_prev] = 1
        state = [
            debnorm,
            ...
            self.time / 40
        ] + dir_actuelle + dir_prev + dir_prev_prev # On fusionne les listes
    ...
    def play_step(self, action, plot_scores, plot_mean_scores, agent):
        ...
        self.time -= 1
        self.dir_idx_prev_prev = self.dir_idx_prev
